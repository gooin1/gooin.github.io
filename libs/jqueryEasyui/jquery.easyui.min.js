...
var s=$(_260).find("div.panel:visible,div.accordion.html:visible,div.tabs-container:visible,div.layout:visible,.easyui-fluid:visible").filter(function(_262,el){
...
var _2b5=0;
var _2b6="auto";
var _2b7=cc.find(">.panel>.accordion.html-header");
if(_2b7.length){
...
pp.panel($.extend({},{collapsible:true,minimizable:false,maximizable:false,closable:false,doSize:false,collapsed:true,headerCls:"accordion.html-header",bodyCls:"accordion.html-body"},_2d4,{onBeforeExpand:function(){
...
_2d5.addClass("accordion.html-header-selected");
_2d5.find(".accordion.html-collapse").removeClass("accordion.html-expand");
},onExpand:function(){
if(_2d4.onExpand){
...
_2d6.removeClass("accordion.html-header-selected");
_2d6.find(".accordion.html-collapse").addClass("accordion.html-expand");
},onCollapse:function(){
if(_2d4.onCollapse){
